...
import pl.edu.icm.unity.samlidp.saml.ctx.SAMLContext;
...
public abstract class StatusResponseProcessor<T extends XmlObject, C extends RequestAbstractType>
{
	...
	protected SamlProperties getSamlConfiguration()
	{
	...
	protected NameIDType getResponseIssuer()
	{
		...
		ret.setStringValue(samlConfiguration.getValue(SamlProperties.ISSUER_URI));
		return ret;
	}
