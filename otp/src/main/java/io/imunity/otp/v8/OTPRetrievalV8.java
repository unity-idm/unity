...
class OTPRetrievalV8 extends AbstractCredentialRetrieval<OTPExchangeV8> implements VaadinAuthentication
{
	...
	@Autowired
	public OTPRetrievalV8(MessageSource msg, CredentialEditorRegistryV8 credEditorReg)
	{	
	...
	static class Factory extends AbstractCredentialRetrievalFactory<OTPRetrievalV8>
	{
		@Autowired
