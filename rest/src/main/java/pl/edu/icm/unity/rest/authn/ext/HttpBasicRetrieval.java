 ...
 * TODO - lot of duplicated code with the WS version
 * @author K. Benedyczak
 */
public class HttpBasicRetrieval implements CredentialRetrieval, JAXRSAuthentication
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_REST, HttpBasicRetrieval.class);
