 ...
 */
@PrototypeComponent
public class EditAttributeTypeView extends CustomComponent implements UnityView
{
	...
	@Autowired
	EditAttributeTypeView(AttributeTypeController controller, UnityMessageSource msg)
	{
		super();
	...
	{
		@Autowired
		public EditAttributeTypeNavigationInfoProvider(AttributeTypesNavigationInfoProvider parent,
				ObjectFactory<EditAttributeTypeView> factory)
		{
