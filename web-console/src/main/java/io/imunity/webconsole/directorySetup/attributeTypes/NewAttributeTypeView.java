 ...
 */
@PrototypeComponent
public class NewAttributeTypeView extends CustomComponent implements UnityView
{
	...
	@Autowired
	NewAttributeTypeView(AttributeTypeController controller, UnityMessageSource msg)
	{
		super();
