...
@PrototypeComponent
class ComboInvitationViewerV8 extends CustomComponent implements InvitationViewer
{
	...
	private final PrefilledEntriesViewerV8 regPrefillViewer;
	private final PrefilledEntriesViewerV8 enqPrefillViewer;
	private final ViewerUtilsV8 utils;

	private Label regFormId;
	private Label enqFormId;

	ComboInvitationViewerV8(PublicRegistrationURLSupport publicRegistrationURLSupport, MessageSource msg,
			CommonInvitationFieldViewerV8 baseViewer, PrefilledEntriesViewerV8 regPrefillViewer,
			PrefilledEntriesViewerV8 enqPrefillViewer, ViewerUtilsV8 utils)
	{
		this.msg = msg;
