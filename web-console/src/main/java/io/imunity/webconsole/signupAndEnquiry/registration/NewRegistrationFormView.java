 ...
 */
@PrototypeComponent
public class NewRegistrationFormView extends CustomComponent implements UnityView
{
	...
	NewRegistrationFormView(RegistrationFormsController controller, UnityMessageSource msg)
	{
	...
	public static class NewRegistrationFormNavigationInfoProvider extends WebConsoleNavigationInfoProviderBase
	{
		...
		@Autowired
		public NewRegistrationFormNavigationInfoProvider(SignupAndEnquirySetupNavigationInfoProvider parent,
