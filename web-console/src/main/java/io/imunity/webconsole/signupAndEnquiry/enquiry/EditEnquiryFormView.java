 ...
 */
@PrototypeComponent
public class EditEnquiryFormView extends CustomComponent implements UnityView
{
	...
	EditEnquiryFormView(EnquiryFormsController controller, UnityMessageSource msg)
	{
	...
	public static class EditEnquiryFormNavigationInfoProvider extends WebConsoleNavigationInfoProviderBase
	{
		...
		@Autowired
		public EditEnquiryFormNavigationInfoProvider(SignupAndEnquirySetupNavigationInfoProvider parent,
				ObjectFactory<EditEnquiryFormView> factory)
		{
