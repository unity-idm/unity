 ...
 */
@PrototypeComponent
class EnquiryReviewPanelV8 extends RequestReviewPanelBase
{
	private static final String UNKNOWN_IDENTITY = "DELETED USER";
	
	private static final Logger log = Log.getLogger(Log.U_SERVER_WEB, EnquiryReviewPanelV8.class);
	private Label entity;
	private EntityManagement identitiesManagement;
	
	@Autowired
	EnquiryReviewPanelV8(MessageSource msg, AttributeHandlerRegistryV8 handlersRegistry,
