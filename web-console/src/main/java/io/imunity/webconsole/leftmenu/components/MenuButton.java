...
public class MenuButton extends Button implements MenuComponent<MenuButton> {
	...
	public static final String STYLE_NAME = "menuButton";
...
//	}
	...
	public boolean isActive() {
		return getStyleName().contains(ACTIVE_STYLE);
	}
	
	public MenuButton setActive(boolean active) {
		if (active != isActive()) {
			if (active) {
				addStyleName(ACTIVE_STYLE);
			} else {
				removeStyleName(ACTIVE_STYLE);
			}
		}
		return this;
	}
