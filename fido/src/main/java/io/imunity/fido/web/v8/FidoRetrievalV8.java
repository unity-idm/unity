 ...
 */
@PrototypeComponent
public class FidoRetrievalV8 extends AbstractCredentialRetrieval<FidoExchange> implements VaadinAuthentication
{
	private Logger log = Log.getLogger(Log.U_SERVER_WEB, FidoRetrievalV8.class);
	...
	@Autowired
	public FidoRetrievalV8(MessageSource msg, CredentialEditorRegistryV8 credEditorReg)
	{	
	...
	public static class Factory extends AbstractCredentialRetrievalFactory<FidoRetrievalV8>
	{
		@Autowired
		public Factory(ObjectFactory<FidoRetrievalV8> factory)
		{
