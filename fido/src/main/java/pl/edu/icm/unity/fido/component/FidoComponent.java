 ...
 */
package pl.edu.icm.unity.fido.component;
...
public class FidoComponent extends AbstractJavaScriptComponent
{
	...
	public static FidoComponentBuilder builder(final FidoManagement fidoManagement, final UnityMessageSource msg)
	{
	...
	public static final class FidoComponentBuilder
	{
		...
		private FidoComponentBuilder(final FidoManagement fidoManagement, final UnityMessageSource msg)
		{
