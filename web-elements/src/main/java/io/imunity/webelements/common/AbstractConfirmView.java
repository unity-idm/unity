...
public abstract class AbstractConfirmView extends VerticalLayout
		implements Button.ClickListener, UnityView
{
	...
	public void enter(ViewChangeEvent event)
	{
		try
		{
			contentsComponent = getContents(event);
		} catch (Exception e)
		{
	...
	protected abstract Component getContents(ViewChangeEvent event) throws Exception;
