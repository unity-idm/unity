...
public class ProxyAuthenticationFilter implements Filter
{
	 ...
	 * and should not be started again. This must be set and cleaned by {@link io.imunity.vaadin.auth.ProxyAuthenticationCapable}
	 * authenticators 
	 */
	...
	private final boolean triggerByDefault;
