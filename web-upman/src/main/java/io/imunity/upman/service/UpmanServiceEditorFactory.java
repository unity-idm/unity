 ...
 */
@Component
public class UpmanServiceEditorFactory implements ServiceEditorFactory
{
	...
	@Autowired
	public UpmanServiceEditorFactory(UnityMessageSource msg, RealmsManagement realmsMan,
	...
	public ServiceEditor createInstance() throws EngineException
	{
		...
		return new UpmanServiceEditor(msg, uriAccessService, fileStorageService, serverConfig,
