...
public class AuditManager
{
	...
	@Autowired
	public AuditManager(EventProcessor eventProcessor, AuditEventDAO dao,
						AttributeDAO attributeDAO, EmailFacility emailFacility,
						AttributeSupport attributeSupport, TransactionalRunner tx)
	{
