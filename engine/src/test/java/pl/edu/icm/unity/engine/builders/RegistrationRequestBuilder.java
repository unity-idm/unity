 ...
 */
public class RegistrationRequestBuilder extends
		RegistrationRequestBuilderBase<RegistrationRequestBuilder>
{
...
class RegistrationRequestBuilderBase<GeneratorT extends RegistrationRequestBuilderBase<GeneratorT>>
{
	private RegistrationRequest instance;

	protected RegistrationRequestBuilderBase(RegistrationRequest aInstance)
	{
		instance = aInstance;
	}

	protected RegistrationRequest getInstance()
	{
		return instance;
	}
