...
public class GroupMemberServiceImplTest extends DBIntegrationTestBase
{
	@Autowired
	...
	public void shouldRetrieveGroupMemberAttributesForSingleGroup() throws EngineException
	{
		...
		List<SimpleGroupMember> groupMembers = groupMemberService.getGroupMembers("/A", List.of(AUTHORIZATION_ROLE));
	...
	public void shouldRetrieveGroupMemberAttributesForTwoGroups() throws EngineException
	{
		...
		Map<String, List<SimpleGroupMember>> groupMembers = groupMemberService.getGroupMembers(List.of("/A", "/B"), List.of(AUTHORIZATION_ROLE));
