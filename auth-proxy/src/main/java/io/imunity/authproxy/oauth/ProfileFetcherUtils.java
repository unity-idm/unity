...
//TODO mostly copied
class ProfileFetcherUtils
{
	static UserAttributes fetchFromJsonObject(JSONObject jsonObject)
	{
		return new UserAttributes(convertToAttributes(jsonObject));
	}

	private static Map<String, List<String>> convertToAttributes(JSONObject profile)
	{
