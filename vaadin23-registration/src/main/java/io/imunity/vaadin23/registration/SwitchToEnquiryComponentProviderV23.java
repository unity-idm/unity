...
package io.imunity.vaadin23.registration;
...
@Component
public class SwitchToEnquiryComponentProviderV23
{
	...
	SwitchToEnquiryComponentProviderV23(MessageSource msg, PublicRegistrationURLSupport publicRegistrationURLSupport)
	{
		this.msg = msg;
