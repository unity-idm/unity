...
@PrototypeComponent
class OTPWithLDAPAuthenticatorEditorV8 extends BaseAuthenticatorEditor implements AuthenticatorEditor
{
	...
	@Autowired
	OTPWithLDAPAuthenticatorEditorV8(MessageSource msg, PKIManagement pkiMan) throws EngineException
	{
		super(msg);
		this.pkiMan = pkiMan;
	...
	{
		private ObjectFactory<OTPWithLDAPAuthenticatorEditorV8> factory;

		@Autowired
		OTPWithLDAPEditorFactory(ObjectFactory<OTPWithLDAPAuthenticatorEditorV8> factory)
		{
