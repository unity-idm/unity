...
class ClientPublicKeysCredentialDefinitionEditor implements CredentialDefinitionEditor, CredentialDefinitionViewer
{
	private final MessageSource msg;

	ClientPublicKeysCredentialDefinitionEditor(MessageSource msg)
	{
		this.msg = msg;
	}
	...
	{
		return new VerticalLayout(new Span(msg.getMessage("ClientPublicKeysCredentialDefinitionEditor.info")));
	}
