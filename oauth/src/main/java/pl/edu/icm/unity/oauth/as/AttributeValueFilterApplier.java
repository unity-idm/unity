...
class AttributeValueFilterApplier
{
	static Set<DynamicAttribute> filterAttributes(List<AttributeValueFilter> filter,
			Collection<DynamicAttribute> attributes)
	{
		...
		Map<String, AttributeValueFilter> filtersByAttrName = filter.stream()
