...
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_ATTR_INTROSPECTION, AttrIntrospectionServiceController.class);
	...
	public ServiceEditor getEditor(SubViewSwitcher subViewSwitcher) throws EngineException
	{
		...
		return new AttrIntrospectionServiceEditor(msg,
				...
				server.getUsedContextPaths(), authenticatorSupportService, () -> getRemoteAuthnOptions(), () -> getIdPs());
	}
