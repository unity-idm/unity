 ...
 */
package io.imunity.vaadin23.shared.endpoint.fido;
...
@JsModule("./fido.js")
@Tag("div")
public class FidoV23Component extends Component
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_FIDO, FidoV23Component.class);
