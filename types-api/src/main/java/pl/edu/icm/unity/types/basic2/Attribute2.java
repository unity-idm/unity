 ...
 * <p> 
 * This version is to be used in preference to {@link Attribute}, which will be effectively replaced by this class.
 * <p>
 * @author K. Benedyczak
 */
public class Attribute2 implements NamedObject
{
	private String name;
	 ...
	 * @param values
	 */
	public Attribute2(String name, String valueSyntax, String groupPath, List<String> values)
	{
		this.name = name;
	 ...
	 */
	@JsonCreator
	public Attribute2(ObjectNode src)
	{
		fromJson(src);
	}
	 ...
	 * @param src
	 */
	public Attribute2(String name, String valueSyntax, String groupPath, ObjectNode src)
	{
		this.name = name;
		this.valueSyntax = valueSyntax;
		this.groupPath = groupPath;
