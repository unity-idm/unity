...
@JsonDeserialize(builder = RestExternalizedAttribute.Builder.class)
...
public class RestExternalizedAttribute
{
	...
	public int hashCode()
	{
		return Objects.hash(creationTs, direct, groupPath, name, remoteIdp, simpleValues, translationProfile, updateTs,
				valueSyntax, values);
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		RestExternalizedAttribute other = (RestExternalizedAttribute) obj;
		return Objects.equals(creationTs, other.creationTs) && direct == other.direct
				...
				&& Objects.equals(remoteIdp, other.remoteIdp) && Objects.equals(simpleValues, other.simpleValues)
