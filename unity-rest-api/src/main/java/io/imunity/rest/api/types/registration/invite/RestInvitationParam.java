...
@JsonSubTypes(
{ @JsonSubTypes.Type(value = RestRegistrationInvitationParam.class, name = "REGISTRATION"),
		@JsonSubTypes.Type(value = RestEnquiryInvitationParam.class, name = "ENQUIRY"),
		@JsonSubTypes.Type(value = RestComboInvitationParam.class, name = "COMBO") })
public abstract class RestInvitationParam
{
	...
	protected RestInvitationParam(RestInvitationParamBuilder<?> builder)
	{
