...
public class RestGroupMemberTest extends RestTypeBase<RestGroupMember>
{

	@Override
	protected String getJson()
	{
		return "{\"group\":\"/\",\"entity\":{\"entityInformation\":{\"state\":\"valid\","
				+ "\"ScheduledOperationTime\":1,\"ScheduledOperation\":\"DISABLE\","
				+ "\"RemovalByUserTime\":1,\"entityId\":1},"
				+ "\"identities\":[{\"value\":\"test@wp.pl\",\"realm\":\"realm\",\"target\":\"target\","
				+ "\"translationProfile\":\"Profile\",\"remoteIdp\":\"remoteIdp\","
				+ "\"confirmationInfo\":{\"confirmed\":true,\"confirmationDate\":1,"
				+ "\"sentRequestAmount\":1},\"metadata\":{\"1\":\"v\"},"
				+ "\"comparableValue\":\"test@wp.pl\",\"creationTs\":1,"
				+ "\"updateTs\":1,\"typeId\":\"email\",\"entityId\":1}],"
				+ "\"credentialInfo\":{\"credentialRequirementId\":\"credreq1\","
				+ "\"credentialsState\":{\"test\":{\"state\":\"correct\",\"stateDetail\":\"state\""
				+ ",\"extraInformation\":\"state\"}}}},\"attributes\":[{\"remoteIdp\":\"remoteIdp\","
				+ "\"translationProfile\":\"translationProfile\",\"values\":[\"v1\",\"v2\"],\"creationTs\":100,"
				+ "\"updateTs\":1000,\"direct\":true,\"name\":\"attr\",\"groupPath\":\"/A\","
				+ "\"valueSyntax\":\"syntax\"}]}\n";
	}

	@Override
	protected RestGroupMember getObject()
	{
