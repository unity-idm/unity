...
public class RestInvitationWithCodeTest extends RestTypeBase<RestInvitationWithCode>
{
	...
	protected String getJson()
	{
		return "{\"type\":\"REGISTRATION\",\"expiration\":1,\"contactAddress\":\"contactAddress\","
				...
				+ "\"valueSyntax\":\"syntax\"},\"mode\":\"READ_ONLY\"}},\"messageParams\":{\"mpk1\":\"mpv1\"},\"registrationCode\":\"code\","
				+ "\"lastSentTime\":1,\"creationTime\":1673896228000,\"numberOfSends\":1}\n";
	}

	@Override
	protected RestInvitationWithCode getObject()
	{
		...
		return RestInvitationWithCode.builder()
				.withNumberOfSends(1)
				.withCreationTime(Instant.ofEpochMilli(1673896228000L))
				.withNumberOfSends(1)
