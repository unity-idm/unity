...
public class RestFormPrefillTest extends RestTypeBase<RestFormPrefill>
{

	@Override
	protected String getJson()
	{
		return "{\"formId\":\"formId\",\"identities\":{\"1\":{\"entry\":{\"value\":\"test@wp.pl\",\"realm\":\"realm\","
	...
	@Override
	protected RestFormPrefill getObject()
	{
