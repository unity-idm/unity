 ...
 * @author K. Benedyczak
 */
public class AbstractBoundEditor2<T extends Number> extends CustomField<ValueWrapper>
{
	...
	public AbstractBoundEditor2(UnityMessageSource msg, String labelUnlimited, String labelLimit,
			T bound, T min, T max)
	{
		this.msg = msg;
		this.bound = bound;
	...
	public AbstractBoundEditor2<T> setMin(T min)
	{
		this.min = min;
		return this;
	}
	
	public AbstractBoundEditor2<T> setMax(T max)
	{
		this.max = max;
		return this;
	}
	
	public AbstractBoundEditor2<T> setReadOnly()
	{
