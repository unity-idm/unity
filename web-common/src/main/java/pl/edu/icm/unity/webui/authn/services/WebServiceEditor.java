...
import pl.edu.icm.unity.webui.authn.services.authnlayout.WebServiceAuthnScreenLayoutEditor;
import pl.edu.icm.unity.webui.authn.services.authnlayout.WebServiceReturningLayoutEditor;
...
/**
 * Editor for services with web binding.
 * @author P.Piernik
 *
 */
	...
	public static class ServiceWebConfiguration
	{
				...
				String serviceName)
		{
			...
			if (logo != null)
			{
				...
				raw.put(VaadinEndpointProperties.PREFIX
						+ VaadinEndpointProperties.AUTHN_LOGO,
						"");
			}
