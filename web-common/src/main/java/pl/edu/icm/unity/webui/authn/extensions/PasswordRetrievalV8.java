 ...
 */
@PrototypeComponent
public class PasswordRetrievalV8 extends AbstractCredentialRetrieval<PasswordExchange> implements VaadinAuthentication
{
	public static final String NAME = "web-password";
	public static final String DESC = "WebPasswordRetrievalFactory.desc";
	
	private Logger log = Log.getLogger(Log.U_SERVER_WEB, PasswordRetrievalV8.class);
	...
	@Autowired
	public PasswordRetrievalV8(MessageSource msg, CredentialEditorRegistryV8 credEditorReg)
	{
	...
	public static class FactoryV8 extends AbstractCredentialRetrievalFactory<PasswordRetrievalV8>
	{
		@Autowired
		public FactoryV8(ObjectFactory<PasswordRetrievalV8> factory)
		{
