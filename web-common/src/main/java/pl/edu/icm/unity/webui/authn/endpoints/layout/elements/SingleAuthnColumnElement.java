...
import pl.edu.icm.unity.webui.authn.endpoints.authnlayout.ColumnElementWithValue;
...
public class SingleAuthnColumnElement extends ColumnElementBase implements ColumnElementWithValue<String>
{
	...
	private List<AuthenticationOptionKey> refreshItems()
	{
		...
		try
		{
			items.addAll(AuthnColumnElementHelper.init(authenticatorSupport, authnOptionSupplier.get(), false));
