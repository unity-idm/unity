...
import static pl.edu.icm.unity.webui.common.credentials.fido.FidoCredentialInfoWrapper.CredentialState.DELETED;
import static pl.edu.icm.unity.webui.common.credentials.fido.FidoCredentialInfoWrapper.CredentialState.NEW;
...
public class FidoPreviewComponent extends CustomComponent
{
	...
	private VerticalLayout getStatusLayout(final Runnable deleteCallback)
	{
		...
		{
			credState.setValue("*");
			credState.addStyleName(Styles.bold.toString());
			credState.addStyleName(Styles.green.toString());
		}
