 ...
 */
@PrototypeComponent
public class SMSRetrievalV8 extends AbstractCredentialRetrieval<SMSExchange> implements VaadinAuthentication
{
	private Logger log = Log.getLogger(Log.U_SERVER_WEB, SMSRetrievalV8.class);
	...
	@Autowired
	public SMSRetrievalV8(MessageSource msg, CredentialEditorRegistryV8 credEditorReg)
	{	
	...
	public static class Factory extends AbstractCredentialRetrievalFactory<SMSRetrievalV8>
	{
		@Autowired
		public Factory(ObjectFactory<SMSRetrievalV8> factory)
		{
