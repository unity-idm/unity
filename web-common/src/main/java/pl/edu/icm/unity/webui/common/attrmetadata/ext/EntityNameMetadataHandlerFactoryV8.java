 ...
 */
@Component
public class EntityNameMetadataHandlerFactoryV8 implements WebAttributeMetadataHandlerFactory
{
	private MessageSource msg;
	
	@Autowired
	public EntityNameMetadataHandlerFactoryV8(MessageSource msg)
	{
		this.msg = msg;
	}
