 ...
 */
@Component
public class EnquiryResponseEditorControllerV8
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_WEB, EnquiryResponseEditorControllerV8.class);
	...
	@Autowired
	public EnquiryResponseEditorControllerV8(MessageSource msg,
