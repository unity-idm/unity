...
@Component
class SwitchToEnquiryComponentProviderV8
{
	...
	SwitchToEnquiryComponentProviderV8(MessageSource msg, PublicRegistrationURLSupport publicRegistrationURLSupport)
	{
		this.msg = msg;
			...
			Map<String, Object> params)
	{
		...
		paramsWithSwitch.put(SWITCH_TO_ENQUIRY_START_VAR, SwitchToEnquiryComponentProviderV8.SWITCH_START);
		paramsWithSwitch.put(SWITCH_TO_ENQUIRY_END_VAR, SwitchToEnquiryComponentProviderV8.SWITCH_END);
