 ...
 */
@PrototypeComponent
public class RemoteRedirectedAuthnResponseProcessingFilterV8 implements Filter
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_AUTHN, RemoteRedirectedAuthnResponseProcessingFilterV8.class);
