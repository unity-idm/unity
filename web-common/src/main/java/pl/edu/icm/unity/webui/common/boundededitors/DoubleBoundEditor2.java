 ...
 * @author K. Benedyczak
 */
public class DoubleBoundEditor2 extends AbstractBoundEditor2<Double>
{

	public DoubleBoundEditor2(UnityMessageSource msg, String labelUnlimited, String labelLimit,
