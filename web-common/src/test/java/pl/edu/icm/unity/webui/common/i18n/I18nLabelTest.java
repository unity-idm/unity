...
public class I18nLabelTest
{
	...
	{
		String ret = I18nLabel2.breakLines("123 567 901234567890", 10);
		Assert.assertEquals("123 567 \n9012345678\n90", ret);

		ret = I18nLabel2.breakLines("123 567 90", 10);
		Assert.assertEquals("123 567 90", ret);

		ret = I18nLabel2.breakLines("12345678901", 10);
	...
	{
		String ret = I18nLabel2.breakLines("1234567890\n1234567890\n", 10);
		Assert.assertEquals("1234567890\n1234567890\n", ret);
	}
