...
public class RegistrationFormEditDialog extends AbstractDialog
{
	...
	protected void onConfirm()
	{
		try
		{
			...
			if (callback.newForm(form, editor.isIgnoreRequests(), editor.isIgnoreInvitations()))
				close();
	...
	{
		public boolean newForm(RegistrationForm form, boolean ignoreRequests, boolean ignoreInvitations);
	}
}
