...
import io.imunity.scim.console.v8.EditSchemaSubView.EditSchemaSubViewFactory;
...
class SCIMServiceEditorSchemaTab extends CustomComponent implements EditorTab
{
	...
	@org.springframework.stereotype.Component("SCIMServiceEditorSchemaTabFactoryV8")
