...
public class SAMLRetrievalUI implements VaadinAuthenticationUI
{
	...
	private final LogoExposingServiceV8 logoExposingService;
	...
	public SAMLRetrievalUI(MessageSource msg, SAMLExchange credentialExchange,
			...
			Context context, AuthenticationStepContext authenticationStepContext, LogoExposingServiceV8 logoExposingService)
	{
		this.msg = msg;
