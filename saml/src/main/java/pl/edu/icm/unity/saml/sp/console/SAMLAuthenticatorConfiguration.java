...
{
	private static Logger log = Log.getLogger(Log.U_SERVER_SAML, SAMLAuthenticatorConfiguration.class);
			...
			String name) throws ConfigurationException
	{
		...
		raw.put(SAMLSPProperties.P + SAMLSPProperties.INCLUDE_ADDITIONAL_CREDENTIAL_IN_METADATA, String.valueOf(
				includeAdditionalCredentialInMetadata));
			...
			VaadinLogoImageLoader imageAccessService, MessageSource msg, String properties)
	{
		...
		setIncludeAdditionalCredentialInMetadata(samlSpProp.getBooleanValue(SAMLSPProperties.INCLUDE_ADDITIONAL_CREDENTIAL_IN_METADATA));
		...
		setDefaultRequestedNameFormat(defNameFormat != null ? Arrays.asList(defNameFormat) : new ArrayList<>());
	...
	{
		return includeAdditionalCredentialInMetadata;
	}
