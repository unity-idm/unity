...
public class RemoteMetadataService
{
	...
	@Autowired
	public RemoteMetadataService(ExecutorsService executorsService, PKIManagement pkiManagement,
	...
	RemoteMetadataService(ExecutorsService executorsService, MetadataDownloader downloader)
	{
		this.executorsService = executorsService;
