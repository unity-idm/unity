 ...
 * @author K. Benedyczak
 */
public class SAMLProxyAuthnHandlerEE8
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_SAML,
			SAMLProxyAuthnHandlerEE8.class);
	...
	public SAMLProxyAuthnHandlerEE8(SAMLExchange credentialExchange, SamlContextManagement samlContextManagement,
