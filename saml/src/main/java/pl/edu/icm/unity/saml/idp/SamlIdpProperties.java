...
public class SamlIdpProperties extends SamlProperties
{
	...
	public static final String ALTERNATIVE_CREDENTIAL = "alternativeCredential";
	...
	static
	{
		...
		defaults.put(ALTERNATIVE_CREDENTIAL, new PropertyMD().setCategory(samlCat).
				setDescription("SAML IdP alternative credential name."));	
