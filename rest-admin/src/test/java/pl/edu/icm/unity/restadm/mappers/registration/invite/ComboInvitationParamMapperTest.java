...
public class ComboInvitationParamMapperTest extends MapperTestBase<ComboInvitationParam, RestComboInvitationParam>
{
	...
	protected RestComboInvitationParam getFullRestObject()
	{
		...
		RestFormPrefill formPrefill = RestFormPrefill.builder()
				.withFormId("formId")
	...
	@Override
	protected Pair<Function<ComboInvitationParam, RestComboInvitationParam>, Function<RestComboInvitationParam, ComboInvitationParam>> getMapper()
	{
