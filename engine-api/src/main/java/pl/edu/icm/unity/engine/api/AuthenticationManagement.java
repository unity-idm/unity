...
public interface AuthenticationManagement
{
	 ...
	 * @throws EngineException
	 */
	AuthenticatorInstance createAuthenticator(String id, String typeId, String jsonVerificatorConfig,
	 ...
	 * @throws EngineException
	 */
	void updateAuthenticator(String id, String jsonVerificatorConfig,
