 ...
 * @author K. Benedyczak
 */
public class UnsuccessfulAuthenticationCounterImpl implements UnsuccessfulAuthenticationCounter
{
	private static final Logger log = Log.getLogger(Log.U_SERVER_AUTHN, UnsuccessfulAuthenticationCounterImpl.class);
	private int maxAttepts;
	private long blockTime;
	private Map<String, ClientInfo> accessMap;
	
	public UnsuccessfulAuthenticationCounterImpl(int maxAttepts, long blockTime)
	{
