...
/**
 * Easy access to AuthenticatorInstance storage, no chache
 * <p>
 ...
 * @author K. Benedyczak
 */
class AuthenticatorInstanceDBNoChacheImpl extends GenericObjectsDAOImpl<AuthenticatorInstance> 
		implements AuthenticatorInstanceDB
{
	AuthenticatorInstanceDBNoChacheImpl(AuthenticatorInstanceHandler handler,
