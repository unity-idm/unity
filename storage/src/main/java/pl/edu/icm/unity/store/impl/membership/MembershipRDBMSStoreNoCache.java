 ...
 * @author K. Benedyczak
 */
class MembershipRDBMSStoreNoCache implements MembershipDAO, RDBMSDAO
{
	private MembershipJsonSerializer jsonSerializer;
	private GroupDAO groupDAO;
	
	MembershipRDBMSStoreNoCache(MembershipJsonSerializer jsonSerializer, GroupDAO groupDAO)
	{
