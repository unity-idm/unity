...
public class DBBaseFormNotifications
{
	...
	protected DBBaseFormNotifications(RestBaseFormNotificationsBuilder<?> builder)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		DBBaseFormNotifications other = (DBBaseFormNotifications) obj;
	...
	public static class RestBaseFormNotificationsBuilder<T extends RestBaseFormNotificationsBuilder<?>>
	{
		...
		public DBBaseFormNotifications build()
		{
			return new DBBaseFormNotifications(this);
		}
	}
