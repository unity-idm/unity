...
@JsonDeserialize(builder = DBFormSeparatorElement.Builder.class)
public class DBFormSeparatorElement extends DBFormElement
{

	private DBFormSeparatorElement(Builder builder)
	{
		super(builder);
	}
	...
	public static final class Builder extends RestFormElementBuilder<Builder>
	{
		...
		public DBFormSeparatorElement build()
		{
			return new DBFormSeparatorElement(this);
		}
	}
