 ...
 * @author K. Benedyczak
 */
public abstract class GenericObjectIEBase2<T extends NamedObject> extends AbstractIEBase<Entry<T, Date>>
{
	private NamedCRUDDAOWithTS<T> dao;
	protected ObjectMapper jsonMapper;
	
	public GenericObjectIEBase2(NamedCRUDDAOWithTS<T> dao, ObjectMapper jsonMapper,
