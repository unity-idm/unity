...
@JsonDeserialize(builder = DBAdminComment.Builder.class)
public class DBAdminComment
{
	...
	private DBAdminComment(Builder builder)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		DBAdminComment other = (DBAdminComment) obj;
	...
	public static final class Builder
	{
		...
		public DBAdminComment build()
		{
			return new DBAdminComment(this);
		}
	}
