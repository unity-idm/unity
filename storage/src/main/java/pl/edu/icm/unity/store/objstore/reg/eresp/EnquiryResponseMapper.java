...
{
	public static DBEnquiryResponse map(EnquiryResponse registrationRequest)
	{
	...
	public static EnquiryResponse map(DBEnquiryResponse restRegistrationRequest)
	{
		EnquiryResponse registrationRequest = new EnquiryResponse();
