...
/**
 * RDBMS storage of {@link Group} without caching
 * @author K. Benedyczak
 */
public class GroupRDBMSStoreNoCache extends GenericNamedRDBMSCRUD<Group, GroupBean> implements GroupDAOInternal
{
	public GroupRDBMSStoreNoCache(GroupJsonSerializer jsonSerializer)
	{
