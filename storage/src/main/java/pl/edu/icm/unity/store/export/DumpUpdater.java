...
import pl.edu.icm.unity.store.migration.from2_5.JsonDumpUpdateFromV5;
...
public class DumpUpdater
{
	...
	@Autowired
	private JsonDumpUpdateFromV5 updateFrom2_5_x;
	...
	public InputStream update(InputStream is, DumpHeader header) throws IOException
	{
		...
		if (header.getVersionMajor() > DumpSchemaVersion.V_SINCE_2_6_0.getVersionCode())
				throw new IOException("Import of data can not be performed from dumps "
