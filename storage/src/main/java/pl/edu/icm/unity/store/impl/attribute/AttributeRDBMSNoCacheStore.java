 ...
 * @author K. Benedyczak
 */
class AttributeRDBMSNoCacheStore extends GenericRDBMSCRUD<StoredAttribute, AttributeBean> 
					implements AttributeDAO
{
	private GroupDAO groupDAO;
	
	AttributeRDBMSNoCacheStore(AttributeRDBMSSerializer dbSerializer, GroupDAO groupDAO)
	{
