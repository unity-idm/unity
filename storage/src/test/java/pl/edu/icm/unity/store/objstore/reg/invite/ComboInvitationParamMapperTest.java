...
public class ComboInvitationParamMapperTest extends MapperTestBase<ComboInvitationParam, DBComboInvitationParam>
{
	...
	@Override
	protected DBComboInvitationParam getFullDBObject()
	{
		ObjectNode meta = Constants.MAPPER.createObjectNode();
		meta.put("1", "v");

		DBFormPrefill formPrefill = DBFormPrefill.builder()
				.withFormId("formId")
		...
		return DBComboInvitationParam.builder()
				...
				.withType("COMBO")
				.withContactAddress("contactAddress")
				.withEnquiryFormPrefill(formPrefill)
				.withRegistrationFormPrefill(formPrefill)
				.build();
	}

	@Override
	protected Pair<Function<ComboInvitationParam, DBComboInvitationParam>, Function<DBComboInvitationParam, ComboInvitationParam>> getMapper()
	{
		return Pair.of(ComboInvitationParamMapper::map, ComboInvitationParamMapper::map);
	}
