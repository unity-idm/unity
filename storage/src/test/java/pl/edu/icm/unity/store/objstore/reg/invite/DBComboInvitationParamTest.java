...
public class DBComboInvitationParamTest extends DBTypeTestBase<DBComboInvitationParam>
{
	...
	@Override
	protected DBComboInvitationParam getObject()
	{
		...
		return DBComboInvitationParam.builder()
				...
				.withEnquiryFormPrefill(DBFormPrefill.builder()
						.withFormId("formId2")
						...
						.withIdentities(Map.of(1,
								new DBPrefilledEntry.Builder<DBIdentityParam>()
										...
										.build()))
						.build())
				.withRegistrationFormPrefill(DBFormPrefill.builder()
						.withFormId("formId")
						.withAllowedGroups(Map.of(1, DBGroupSelection.builder()
								.withExternalIdp("externalIdp")
								.withTranslationProfile("Profile")
